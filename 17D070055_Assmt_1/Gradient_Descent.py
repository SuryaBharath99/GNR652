...
u2 = numpy.zeros((1600,1))
Iter = numpy.zeros((1600,1))

noIt  = -1

#('Upadating weight matrix "w"')
...
#'Finding MSE of TEST data with w matrix obtained after updating')
...
print('Mean Squared Error of TEST data in Gradient Decent is', Test_cost_value)
